...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (email === 'alexandra@alcancari.pt' && password === 'password') {
      navigate('/dashboard')
    } else {
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full bg-teal-700 hover:bg-teal-800 text-white font-semibold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70 mt-2">
