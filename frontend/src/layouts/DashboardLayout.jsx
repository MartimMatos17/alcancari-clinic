      ...
      <div className="p-6 border-b border-gray-50">
        <Link to="/" className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">{isAdmin ? 'Gestão Clínica' : 'Área Clínica'}</p>
          </div>
        </Link>
      </div>

      {isAdmin && (
        <div className="mx-4 mt-4 px-3 py-2 bg-teal-50 rounded-xl border border-teal-100">
          <p className="text-teal-700 text-xs font-semibold">👑 Modo Administrador</p>
          <p className="text-teal-500 text-xs">Acesso total ao sistema</p>
        </div>
      )}
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        <header className="hidden lg:flex bg-white border-b border-gray-100 px-8 py-4 items-center justify-between sticky top-0 z-20">
          <p className="text-sm text-gray-400">
            Olá, <span className="font-semibold text-teal-700">{firstName}</span> 👋
          </p>
